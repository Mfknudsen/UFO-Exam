...
public:
    ...
    static bool
    PointWithinTriangle2DWithTolerance(Vector2 &point, Vector2 &a, Vector2 &b, Vector2 &c);
    ...
    static float Max(float y, float y1);

    static float Clamp(float p, float minValue, float maxValue);
